...
public class Hook {
	...
	//hook the Context of the application
	protected static void hookGetSystemContext(Class<?> _class) {
        Method method;
        try {
                Class<?>[] params = new Class[1];
                params[0] = String.class;

                method = _class.getMethod("getSystemService", params);
	...
	public static void initialize() {
		 ...
		 MS.hookClassLoad("android.app.ContextImpl", new MS.ClassLoadHook() {
             public void classLoaded(Class<?> _class) {
                     hookGetSystemContext(_class);
             }
     });
		

		// hooks and overrides the "getTrustManagers" method from "javax.net.ssl.TrustManagerFactory"
		...
		// hooks and overrides the "setSSLSocketFactory" method from "javax.net.ssl.HttpsURLConnection"
		...
		// hooks and overrides the "init" method from "javax.net.ssl.SSLContext"
