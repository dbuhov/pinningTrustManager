...
public class NotifyService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		myNotification = new Notification(R.drawable.forbidden, "Warning!", System.currentTimeMillis());
		Context context = getApplicationContext();
		String notificationTitle = "There has been a change of some public keys!";
